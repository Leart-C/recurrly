...
export default function SignUp() {
  ...
  if (signUp.status === "complete" || isSignedIn) {
    return <AuthLoadingScreen message="Opening your account…" />;
  }
          ...
          <View className="mt-2 items-center">
            ...
            <Text className="mt-2 max-w-[320px] text-center text-base font-sans-medium text-muted-foreground">
              {needsVerification
                ...
                : "Start tracking renewals and recurring spending."}
            </Text>
          </View>
              ...
              <View className="gap-4">
                ...
                >
                  {isLoading ? (
                    ...
                    <Text className="text-base font-sans-bold text-primary">Verify email</Text>
                  )}
                </Pressable>
                <Pressable
              ...
              <View className="gap-4">
                <View className="gap-2">
                  ...
                  {errors.fields.emailAddress && (
                    <Text className="text-xs font-sans-medium text-destructive">{errors.fields.emailAddress.message}</Text>
                  )}
                </View>
                <View className="gap-2">
                ...
                >
                  {isLoading ? (
                    ...
                    <Text className="text-base font-sans-bold text-primary">Create account</Text>
                  )}
                </Pressable>
                ...
                <View className="mt-5 flex-row items-center justify-center gap-1">
                  ...
                  <Link href="/(auth)/sign-in" className="text-sm font-sans-bold text-accent">Sign in</Link>
                </View>
              </View>
            )}
          </View>
